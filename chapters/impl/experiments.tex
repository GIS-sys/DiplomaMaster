...
\begin{enumerate}
    ...
    \item \textbf{Обучение сегментаторов} для каждой операции. Оценка - доля верно классифицированных рёбер (edge accuracy), доля моделей с accuracy >= 90\%, >=50\%, >=10\%, и метрика IoU.
