...
\begin{itemize}
    ...
    \item \textbf{Результат классификации:} fillet - 99.9\%, cutExtrusion - 25.5\%, chamfer - 73.6\%.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Использованные конфигурации нейронных сетей:} классификация - B, сегментация - E.
    \item \textbf{Результат классификации:} fillet - 99.9\%, cutExtrusion - 15.9\%, chamfer - 91.1\%.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Использованные конфигурации нейронных сетей:} классификация - B, сегментация - E.
    \item \textbf{Результат классификации:} fillet - 85.2\%, cutExtrusion - 49.7\%, chamfer - 93.5\%.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Результат классификации:} fillet - 98.5\%, cutExtrusion - 54.6\%, chamfer - 97.8\%.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Использованные конфигурации нейронных сетей:} классификация - B, сегментация - C.
    \item \textbf{Результат классификации:} fillet - 97.9\%, cutExtrusion - 35.5\%, chamfer - 44.4\%.
\end{itemize}
